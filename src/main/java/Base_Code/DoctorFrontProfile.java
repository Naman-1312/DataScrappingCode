...
public class DoctorFrontProfile {
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                ...
                WebElement nextButton = driver.findElement(By.xpath("//i[contains(text(),'chevron_right')]"));
                if (nextButton.isDisplayed() && nextButton.isEnabled()) {
                    nextButton.click();
                    new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.stalenessOf(list.get(0)));
                } else {
                    break;
                }
            }
